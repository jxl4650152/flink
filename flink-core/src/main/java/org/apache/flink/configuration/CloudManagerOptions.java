...
/**
 * Configuration options for the CloudManager.
 */
@PublicEvolving
public class CloudManagerOptions {
	...
	public static final ConfigOption<String> CLOUD_ID =
		key("cloud.id")
			.stringType()
			.defaultValue("cloud1")
			.withDescription("Cloud Id of cloud manager");
	 ...
	 * for communication with the job manager.
	 *
	 * <p>Like {@link CloudManagerOptions#ADDRESS}, this value is only interpreted in setups where
	...
	public static final ConfigOption<String> CLOUD_MANAGER_HEAP_MEMORY =
		key("cloudmanager.heap.size")
		.defaultValue("1024m")
		.withDescription("JVM heap size for the JobManager.");

	/**
	 * JVM heap size (in megabytes) for the JobManager.
	 * @deprecated use {@link #CLOUD_MANAGER_HEAP_MEMORY}
	 */
	@Deprecated
	public static final ConfigOption<Integer> ClOUD_MANAGER_HEAP_MEMORY_MB =
		key("cloudmanager.heap.mb")
		.defaultValue(1024)
	...
	public static final ConfigOption<Integer> MAX_ATTEMPTS_HISTORY_SIZE =
		key("cloudmanager.execution.attempts-history-size")
			.defaultValue(16)
