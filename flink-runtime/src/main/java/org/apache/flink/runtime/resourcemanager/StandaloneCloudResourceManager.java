 ...
 */
public class StandaloneCloudResourceManager extends ResourceManager<ResourceID> {
	...
	//** location info of this CloudResourceManager **/
	private final String cloudId;

	public StandaloneCloudResourceManager(
