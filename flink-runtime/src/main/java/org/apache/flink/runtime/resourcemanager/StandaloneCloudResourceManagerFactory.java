 ...
 */
public enum StandaloneCloudResourceManagerFactory implements ResourceManagerFactory<ResourceID> {
	INSTANCE;
	...
	public ResourceManager<ResourceID> createResourceManager(
		...
		final String cloudId = ConfigurationUtils.getCloudId(configuration);
		return new StandaloneCloudResourceManager(
			rpcService,
			getEndpointId(),
			resourceId,
			highAvailabilityServices,
