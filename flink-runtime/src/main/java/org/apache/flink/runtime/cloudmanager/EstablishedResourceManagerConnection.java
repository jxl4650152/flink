...
class EstablishedResourceManagerConnection {
	...
	@Nonnull
	private final InstanceID cloudManagerRegistrationId;

	EstablishedResourceManagerConnection(@Nonnull ResourceManagerGateway resourceManagerGateway, @Nonnull ResourceID resourceManagerResourceId, @Nonnull InstanceID cloudManagerRegistrationId) {
		this.resourceManagerGateway = resourceManagerGateway;
		this.resourceManagerResourceId = resourceManagerResourceId;
		this.cloudManagerRegistrationId = cloudManagerRegistrationId;
	}
	...
	@Nonnull
	public InstanceID getCloudManagerRegistrationId() {
		return cloudManagerRegistrationId;
	}
}
